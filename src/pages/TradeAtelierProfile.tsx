...
function pickToLightboxItem(
  ...
  return {
    ...
    materials_description: pick.materials_description,
                ...
                <div className="aspect-[3/2] md:aspect-[2/1] max-h-[50vh]">
                  {(designer.hero_image_url || designer.image_url) && (
                    <img
                      src={designer.hero_image_url || designer.image_url}
                      alt={name}
                      className="absolute inset-0 w-full h-full object-cover [object-position:center_15%] md:[object-position:center_25%]"
                      loading="eager"
                    />
                  )}
