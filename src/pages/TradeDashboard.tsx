...
const quickLinks = [
  ...
  { title: "Quote Builder", description: "Create branded quotes for your clients", icon: FileText, to: "/trade/quotes", image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1773799140/Screen_Shot_2026-03-18_at_9.57.16_AM_mpvvpg.png" },
