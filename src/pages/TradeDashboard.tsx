...
const DASH_CARDS = [
  { key: "dash-showroom", title: "Curated Showroom", description: "Hand-picked pieces staged in our Singapore gallery", icon: MapPin, to: "/trade/showroom", fallbackId: null as string | null, fallbackImage: "https://res.cloudinary.com/dif1oamtj/image/upload/w_1200,c_fill,q_auto:good,f_auto/v1/living-room-hero_zxfcxl", defaultGravity: "center" },
