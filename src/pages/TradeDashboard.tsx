...
const DASH_CARDS = [
  { key: "dash-showroom", title: "Curated Showroom", description: "Hand-picked pieces staged in our Singapore gallery", icon: MapPin, to: "/trade/showroom", fallbackId: "living-room-hero_zxfcxl", fallbackImage: null as string | null, defaultGravity: "auto" },
