...
import {
  ...
  Inbox, Sparkle, Search, MessageSquare, Send,
} from "lucide-react";
...
const commerceGroup: AdminCard[] = [
  ...
  { title: "Trade Applications & Price Upon Request Submissions", description: "Review and approve new trade registrations, and reply to Price-upon-Request inquiries", url: "/trade/admin", icon: Shield },
...
export default function TradeAdminDashboard() {
  ...
  const getBadge = (title: string) => {
    ...
    if (title === "Trade Applications & Price Upon Request Submissions") return pendingApps;
