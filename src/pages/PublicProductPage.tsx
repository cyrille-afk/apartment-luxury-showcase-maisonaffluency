        ...
        <div className="pt-[var(--header-h)] pb-[calc(env(safe-area-inset-bottom,0px)+5rem)] md:pb-20 max-w-7xl mx-auto px-4 md:px-5 lg:px-8">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-3 md:gap-8 lg:gap-16">
            <div
              ...
              className={cn(
                "relative -mx-4 md:mx-0 sticky top-[var(--header-h)] md:top-[calc(var(--header-h)+1rem)] h-fit self-stretch lg:self-start z-40 bg-background transition-all duration-500 ease-out transform will-change-transform",
