    ...
    <>
      ...
      <div className="min-h-[100dvh] w-screen overflow-x-hidden scroll-smooth bg-background pb-[env(safe-area-inset-bottom)]">
        ...
        <div className="relative flex min-h-[calc(100svh-6rem)] w-full flex-col md:grid md:grid-cols-12 md:h-[calc(100vh-256px)] md:min-h-0">
          ...
          <div className="relative h-[60dvh] min-h-[430px] max-h-[620px] w-full bg-background md:aspect-auto md:col-start-7 md:col-span-5 md:h-full md:min-h-0 md:max-h-none">
            <img
