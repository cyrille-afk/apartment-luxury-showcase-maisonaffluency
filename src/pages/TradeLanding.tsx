...
const TRADE_PROGRAM_SHARE_URL = "https://www.maisonaffluency.com/trade-program-share.html?v=20260320e";
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        {/* ─── Full-width Hero ─── */}
        <div className="relative w-full h-[45svh] md:h-[65vh] overflow-hidden">
          <img
