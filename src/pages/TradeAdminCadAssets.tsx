              ...
              <>
                ...
                <dl className="grid grid-cols-2 gap-3 mt-2">
                  ...
                  <div className="col-span-2">
                    <dt className="font-body text-[10px] uppercase tracking-[0.18em] text-muted-foreground">Status</dt>
                    <dd className="font-body text-xs text-foreground">
                      {previewAsset.is_active ? (
                  ...
                  <div className="col-span-2">
                    <dt className="font-body text-[10px] uppercase tracking-[0.18em] text-muted-foreground">File link</dt>
                    <dd className="font-body text-[11px] text-muted-foreground break-all flex items-start gap-2">
                      <span className="flex-1">{previewAsset.file_url}</span>
                      <button
                        type="button"
                        onClick={() => {
                          navigator.clipboard.writeText(previewAsset.file_url);
                          toast({ title: "Link copied" });
                        }}
                        className="p-1 rounded text-muted-foreground hover:text-foreground hover:bg-muted/40 shrink-0"
                        title="Copy link"
                      >
