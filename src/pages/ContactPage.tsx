  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Visit Maison Affluency by appointment in Singapore. Contact our concierge for bespoke inquiries, custom specifications, and design collaborations." />
