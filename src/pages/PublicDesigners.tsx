    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed right-6 z-50 w-10 h-10 flex items-center justify-center rounded-full bg-foreground text-background shadow-lg hover:opacity-80 transition-opacity"
