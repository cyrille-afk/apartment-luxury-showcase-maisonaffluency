          ...
          <div className="text-center mb-6">
            ...
            <div className="mt-2">
              <WhatsAppShareButton
                onClick={(e) => {
                  e.preventDefault();
                  sharePageOnWhatsApp("/trade/register", "Apply to Trade Program — Maison Affluency", "Exclusive access for design professionals", { directUrlPath: "/trade-program-share.html" });
                }}
