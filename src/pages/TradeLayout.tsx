...
const TRADE_GATE_COPY: Record<string, { title: string; description: string; h1: string }> = {
  ...
  "/trade/po-logs": {
    ...
    h1: "Purchase Order Logs",
    description: "Track purchase orders, supplier invoices and vendor payments. Sign in to access the PO logs.",
  },
  "/trade/spec-generator": {
    title: "Specification Sheet Generator | Maison Affluency",
    h1: "Specification Sheet Generator",
    description: "Build branded client specification decks from your project items. Sign in to access the generator.",
  },
  "/trade/reorder": {
