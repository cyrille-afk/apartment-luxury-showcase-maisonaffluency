              ...
              >
                <span className="inline-flex items-center">
                  <span className="inline-flex w-8 items-center justify-start overflow-hidden">
                    <span
                      className={cn(
                        "h-px w-8 bg-current transition-all duration-300 translate-x-8 opacity-0 group-hover:translate-x-0 group-hover:opacity-100",
                  ...
                  <span
                    className={cn(
                      "mx-3 transition-transform duration-300 group-hover:translate-x-8",
                      ctaPressed && "translate-x-8"
                    )}
                  >
                  ...
                  <span className="inline-flex w-8 items-center justify-start overflow-hidden">
                    <span
                      className={cn(
                        "h-px w-8 bg-current transition-all duration-300 translate-x-0 opacity-100 group-hover:translate-x-8 group-hover:opacity-0",
                        ctaPressed && "translate-x-8 opacity-0"
                      )}
                    />
                  </span>
                </span>
