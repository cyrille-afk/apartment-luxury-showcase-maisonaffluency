...
const TradePOLogs = lazy(() => import("./pages/TradePOLogs"));
const TradeGanttTimeline = lazy(() => import("./pages/TradeGanttTimeline"));
              ...
              {MAINTENANCE_MODE ? (
                ...
                <Routes>
                  ...
                  <Route path="/trade" element={<Suspense fallback={null}><TradeErrorBoundary><TradeLayout /></TradeErrorBoundary></Suspense>}>
                    ...
                    <Route path="projects/:id/studio" element={<Suspense fallback={<PageLoadingSkeleton />}><TradeProjectStudio /></Suspense>} />
                    ...
                    <Route path="po-logs" element={<TradePOLogs />} />
                    <Route path="gantt" element={<TradeGanttTimeline />} />
