                ...
                <div key={cat} className="border-b border-border/20 last:border-b-0">
                  ...
                  <div className="flex items-center gap-3 py-3 px-1">
                    ...
                    <span
                      ...
                      className={cn(
                        "flex-1 font-display text-[11px] uppercase tracking-[0.2em] cursor-pointer transition-colors",
                        ...
                        return (
                          <div key={sub} className="flex items-center gap-2.5 py-1.5">
                            ...
                            <span
                              ...
                              className={cn(
                                "font-display text-[10px] tracking-[0.15em] cursor-pointer transition-colors",
                                isActiveSub
