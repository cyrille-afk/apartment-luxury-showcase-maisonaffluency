...
const CategorySidebar: React.FC<CategorySidebarProps> = ({ activeCategory, activeSubcategory, onSelect, className }) => {
  ...
  return (
    <aside className={cn("hidden md:flex flex-col w-44 lg:w-48 shrink-0 pr-1 sticky top-24 self-start max-h-[calc(100vh-7rem)] overflow-y-auto absolute right-full mr-2", className)}>
            ...
            <div key={cat} className="border-b border-border/20 last:border-b-0">
              ...
              <div className="flex items-center gap-3 py-3 px-1">
                ...
                <span
                  ...
                  className={cn(
                    "flex-1 font-body text-[11px] tracking-[0.2em] cursor-pointer transition-colors",
