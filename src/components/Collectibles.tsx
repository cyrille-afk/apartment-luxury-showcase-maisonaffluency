                  ...
                  <AccordionTrigger className="hover:no-underline py-4 md:py-6 group active:scale-[0.99] touch-manipulation [&>svg]:hidden md:[&>svg]:block">
                    ...
                    <div className="hidden md:flex items-center gap-6 flex-shrink-0 mr-8">
                      <button
                            ...
                            className="inline-flex items-center gap-2 md:gap-1 px-4 md:px-2.5 py-2 md:py-1 text-sm md:text-xs font-body rounded-full bg-white hover:bg-white/80 border border-border/40 transition-all duration-300"
                            aria-label={`Share ${designer.name} on WhatsApp`}
                          >
                            <svg className="w-4 h-4 md:w-3 md:h-3 text-foreground" viewBox="0 0 24 24" fill="currentColor">
