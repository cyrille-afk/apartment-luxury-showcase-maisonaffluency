                      ...
                      <div className="flex flex-col items-start gap-1 flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="p-1 rounded-full bg-foreground/5 hover:bg-foreground/15 transition-all duration-300 hover:scale-110"
                            aria-label={`Share ${designer.name} on WhatsApp`}
                          >
                            <svg className="w-5 h-5 md:w-6 md:h-6 text-[#25D366]" viewBox="0 0 24 24" fill="currentColor">
