...
export const collectibleDesigners: Array<{
  ...
  },
  {
    ...
    notableWorks: "Unknow N.83 Cotissi Vessel, Murano Glass Sculptures",
  ...
  },
  {
    id: "rowin-atelier",
    name: "RoWin' Atelier",
    founder: "Rochette Frederic & Winkler Hervé",
  ...
  },
  {
    ...
    philosophy: "Every piece must feel as if it has existed for centuries and yet could only have been made now.",
    curatorPicks: [
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774839458/Screen_Shot_2026-03-30_at_10.55.06_AM_zha34n.png", title: "Amboseli Armchair", category: "Seating", subcategory: "Armchair", materials: "Brown ash wood, bronze, fabric", dimensions: "H 67 cm × W 79 cm × D 77 cm", edition: "Limited Edition of 20 Pieces + AP", description: "Brown ash wooden armchair with cast bronze details and upholstered cushions. Inspired by the moments of everyday African life, weaving a refined dialogue between the tribal aesthetic evocation and the Italian touch.", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/achille-salvagni%2F2018-Amboseli_Spec-Sheet.pdf", pdfFilename: "2018-Amboseli_Spec-Sheet.pdf" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774848165/Screen_Shot_2026-03-30_at_1.22.01_PM_quignb.png", title: "Spider Mini", category: "Lighting", subcategory: "Chandeliers", materials: "Gold plated bronze and lacquered bronze, onyx, light fittings", dimensions: 'H 38.2" W 51" D 55" | H 97 W 130 D 140 cm', edition: "Edition of 20", pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/achille-salvagni/AS_Spider-mini_Spec-Sheet.pdf", pdfFilename: "AS_Spider-mini_Spec-Sheet.pdf" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774847883/Screen_Shot_2026-03-30_at_1.16.46_PM_lyrmbx.png", title: "Linneo Blu Consolle", category: "Tables", subcategory: "Console", materials: "Patinated cast bronze with patinated and natural cast bronze organic shaped lamp", dimensions: "H 130 × W 100 × D 35 cm", edition: "Limited Edition of 6 Pieces + AP", description: "A tribute to the Swedish botanist Carl Linnaeus. The lamp shape abstracts the Ginkgo foliage, a symbol of health and happy life in Chinese culture.", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/linneo-consolle-blu-spec-sheet.pdf", pdfFilename: "Linneo Consolle Blu Spec Sheet" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774848017/Screen_Shot_2026-03-30_at_1.19.20_PM_qukrjr.png", title: "Cosmedin Aluminium", category: "Tables", subcategory: "Side Table", materials: "Breccia Capraia marble base, aluminium top", dimensions: "H 50 × W 43 × D 54 cm", edition: "Edition of 10", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/cosmedin-aluminium-spec-sheet.pdf", pdfFilename: "Cosmedin Aluminium Spec Sheet" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774848385/Screen_Shot_2026-03-30_at_1.25.20_PM_bhb8en.png", title: "Ninfa Centrepiece", category: "Decorative Objects", subcategory: "Centrepiece", materials: "Murano glass", dimensions: "H 30 × W 42 × D 42 cm", edition: "Edition of 20", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/ninfa-centrepiece-spec-sheet.pdf", pdfFilename: "Aldus_Ninfa-Centrepiece_Spec-Sheet.pdf" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774848456/Screen_Shot_2026-03-30_at_1.27.18_PM_fnu2tq.png", title: "Cher Dining Table", category: "Tables", subcategory: "Dining Table", materials: "Bronze and marble top, wood base", dimensions: "H 74 × W 140 × D 140 cm", edition: "Edition of 6", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/cher-dining-table-spec-sheet.pdf", pdfFilename: "AS_Cher_Spec-Sheet.pdf" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774848583/Screen_Shot_2026-03-30_at_1.29.21_PM_lwrtc3.png", title: "Garda", category: "Seating", subcategory: "Sofa", materials: "Lacquered wood, brass, Toyine fabric upholstery", dimensions: "H 74 × W 300 × D 150 cm", edition: "Edition of 6", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/garda-sofa-spec-sheet.pdf", pdfFilename: "AS_Toyine-Garda_Spec-Sheet.pdf" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774848665/Screen_Shot_2026-03-30_at_1.30.47_PM_kpcgnn.png", title: "Drop Breakfast Table", category: "Tables", subcategory: "Side Table", materials: "Bronze, parchment", dimensions: "H 70 × W 86 × D 86 cm", edition: "Edition of 10", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/drop-breakfast-table-spec-sheet.pdf", pdfFilename: "AS_Drop-Breakfast-Table_Spec-Sheet.pdf" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774848801/Screen_Shot_2026-03-30_at_1.32.40_PM_ayewh6.png", title: "Thor", category: "Lighting", subcategory: "Floor Lamps", materials: "Bronze, onyx, light fittings", dimensions: "H 176 × W 67 × D 71 cm", edition: "Edition of 20", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/thor-floor-lamp-spec-sheet.pdf", pdfFilename: "AS_Thor_Spec-Sheet.pdf" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774848886/Screen_Shot_2026-03-30_at_1.34.13_PM_fulduk.png", title: "Vittoria Mini", category: "Seating", subcategory: "Armchair", materials: "Velvet, blue lacquered wood, brass details", dimensions: "H 60 × W 60 × D 82 cm", edition: "Edition of 20 + AP", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/vittoria-mini-spec-sheet.pdf", pdfFilename: "AS_Vittoria-Mini.pdf" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774849026/Screen_Shot_2026-03-30_at_1.36.27_PM_intn4l.png", title: "Bench", category: "Seating", subcategory: "Bench", materials: "Bronze, European walnut, upholstery", dimensions: "H 45 × W 147 × D 54 cm", edition: "Edition of 10", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/bench-spec-sheet.pdf", pdfFilename: "AS_Bench_Spec-Sheet.pdf" },
      { image: "https://res.cloudinary.com/dif1oamtj/image/upload/v1774849096/Screen_Shot_2026-03-30_at_1.37.51_PM_bpnvcj.png", title: "Freida BB", category: "Lighting", subcategory: "Wall Lamps", materials: "Bronze, Murano glass, LED light fittings", dimensions: "H 25 × W 30 × D 12 cm", edition: "Edition of 20", tags: ["limited-edition"], pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/spec-sheets/freida-bb-spec-sheet.pdf", pdfFilename: "AS_Freida-BB_Spec-Sheet.pdf" },
    ],
    links: [
      { type: "Instagram", url: "https://www.instagram.com/achillesalvagni/" },
      { type: "Curators' Picks" },
    ],
  },
];
                        ...
                        >
                          <div className="aspect-[3/4] bg-muted/20 overflow-hidden relative">
                            ...
                            <div className="px-3 py-2 border-t border-border bg-background">
                              {(() => {
                                const shareUrl = heroProduct ? buildPieceOgUrl(designer.name, heroProduct.title) : buildDesignerOgUrl(designer.name);
                                return (
                                  <ShareMenu
                                    url={shareUrl}
                                    message={heroProduct ? `${heroProduct.title} by ${designer.name} — Maison Affluency: ${shareUrl}` : `Check out ${designer.name} at Maison Affluency: ${shareUrl}`}
                             ...
                             {(() => {
                               ...
                               return (
                                 <a
                                   ...
                                   rel="noopener noreferrer"
                                   onClick={(e) => e.stopPropagation()}
                                   className="font-body text-[7px] text-white/40 hover:text-white transition-colors tracking-wide drop-shadow-sm"
                                   aria-label={`${designer.name} on Instagram`}
                                 >
                                   {handle}
                                 </a>
