...
const galleryExperiences = [{
  ...
  items: [{
    ...
    description: "Alinea Design Objects' Angelo M table paired with Eric Schmitt Studio Chairie and Cazes&Conquet Augusta dining chairs, Emanuelle Levet Stenne's Alabaster Pendant Light, Emmanuel Babled's Limited Edition Sculptured Book Cover from his emblematic Osmosi series "
  }]
}, {
