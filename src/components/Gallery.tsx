...
const Gallery = () => {
  ...
  return <>
      <section id="gallery" ref={ref} className="py-16 px-4 md:py-24 md:px-12 lg:px-20 bg-muted/30 scroll-mt-24">
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {/* Mobile tap indicator - stays visible until this specific image is expanded */}
