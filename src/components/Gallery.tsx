...
const galleryExperiences = [{
  ...
  items: [{
    ...
    description: "Apparatus Studio Lantern Table, Reda Amalou, Eggshell DOT side table, Pierre Frey Kagura and Kasimir Fabrics, Peter Reed's Riyad Double Faced Throw and Cushion"
  }]
}];
const Gallery = () => {
