...
const galleryExperiences = [{
  ...
  items: [{
    ...
    description: "Bertrand de Maistre's Lyrical Desk, Hamrei's Pépé Chair, Made in Kira's Toshiro Lamp, Nathalie Ziegler's Saint Just Custom Glass Chandelier and Gold Leaves+Glass Snake Vase, Nika Zupanc's Stardust Loveseat"
  }, {
    image: artMasterBronzeImage,
    title: "The Art Master Bronze Painting",
    description: "Pierre Bonnefille's Bronze Painting, Alexander Lamont's Straw Marquetry Mantle Box, curated design library featuring works from Oitoemponto, Gilles & Boissier, Studio KO, and Jean-Louis Deniot"
  }]
}];
const Gallery = () => {
