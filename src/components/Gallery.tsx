...
const galleryExperiences = [{
  ...
  items: [{
    ...
    description: "Dining Table: Atelier Pendhapa's Deepah Custom Table, Dining Chairs: Hamrei's Pépé Custom Chairs, Blue Vessel: Milan Pekař's Crystalline Vase Volume 3, Pierre Frey's Tuscan Journey Wallcover"
  }, {
