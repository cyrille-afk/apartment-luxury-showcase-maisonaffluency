                    ...
                    <div key={item.id} className="py-3 md:py-4 md:grid md:grid-cols-[minmax(0,1fr)_100px_120px_130px] md:gap-4 md:items-start">
                      <div className="flex gap-3 md:gap-4 min-w-0">
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          {item.edition && <p className="font-body text-[10px] md:text-[11px] text-foreground/80 italic mt-0.5 truncate">Edition: {String(item.edition).replace(/^edition\s*[:\-—]?\s*/i, "").trim()}</p>}
