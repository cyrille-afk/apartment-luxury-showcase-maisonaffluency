...
const HV_CITIES = [
  ...
  "bangkok", "jakarta", "ho chi minh city", "kuala lumpur", "manila", "taipei",
  "sg", "hk", "bkk", "jkt", "hcm", "hcmc", "kl", "mnl", "tpe",
  "sfo", "sf", "lax", "jfk", "dxb", "auh", "doh", "ruh", "cdg", "lhr", "ldn",
  "syd", "mel", "ist", "ath", "bcn", "mad", "ber", "muc", "ams", "bru", "vie",
];

const HV_CITY_EXPANSIONS: Record<string, { city: string; country: string }> = {
