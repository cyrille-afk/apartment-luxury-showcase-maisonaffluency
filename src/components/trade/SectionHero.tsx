...
const heroDefaults: Record<string, { id: string; gravity?: "auto" | "face" | "center" | "north" | "south" | "east" | "west"; rawUrl?: string }> = {
  ...
  documents: { id: "v1774172614/2.-Digital-Resources_qbsqxs", rawUrl: "https://res.cloudinary.com/dif1oamtj/image/upload/w_1600,h_600,c_fill,g_auto,q_auto,f_auto/v1774172614/2.-Digital-Resources_qbsqxs.jpg" },
...
function heroRendition(url: string, width: number, gravity: string): string | null {
  ...
  const chain = [
    ...
    ...(hadUpscale ? ["e_sharpen:200"] : []),
    hadUpscale ? "q_auto:best" : "q_auto:good",
    "f_auto",
  ];
