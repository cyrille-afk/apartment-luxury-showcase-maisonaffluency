...
const DEFAULT_STEPS: Step[] = [
  { id: "showroom",  path: "/trade/the-collection",  title: "1. Browse the Showroom",            body: "Start here to explore curated rooms in situ. Click any hotspot on a photo to open the piece, see specs, trade pricing and add it to a tearsheet.", icon: MapPin,   ctaLabel: "Next: Designers" },
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-3 flex items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    >
                      {isLastStep ? `${chrome.finish} Tour & Open Workspace` : chrome.next}
