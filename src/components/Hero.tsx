          ...
          <div className="mt-8 md:mt-10 flex w-full max-w-3xl flex-col items-start">
            ...
            <div className="hero-mobile-cta-stack w-screen -translate-x-6 items-center md:w-full md:translate-x-0 md:items-start mt-[5.5rem] md:mt-20 flex flex-col gap-6">
              <div className="flex flex-col items-center gap-6 md:inline-flex">
                ...
                <div className="mt-6 flex flex-col items-center gap-3 hero-fade-in-delayed-5 md:mt-6 md:flex-row md:gap-0">
                  <button
                    type="button"
                    onClick={() => {
                    ...
                    className="group text-center font-body text-[11px] font-medium tracking-[0.15em] text-white transition-colors [text-shadow:_0_2px_4px_rgba(0,0,0,0.85)] md:text-xs"
                  >
                  ...
                  <span className="hidden md:mx-3 md:inline-block md:h-3 md:w-px md:bg-white/50" aria-hidden="true" />
                  <button
                    type="button"
                    onClick={openTour}
                    className="group text-center font-body text-[11px] font-medium tracking-[0.15em] text-white transition-colors hover:text-[#E5E5E5] [text-shadow:_0_2px_4px_rgba(0,0,0,0.85)] md:text-xs"
                  >
