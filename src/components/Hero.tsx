...
const heroPrimaryCtaClass =
  "inline-flex min-h-11 items-center justify-center rounded-full border border-black/80 bg-transparent px-6 py-3 text-center text-black text-sm md:text-base font-body font-semibold tracking-wide shadow-[0_8px_30px_rgba(0,0,0,0.22)] backdrop-blur-md transition-all hover:bg-black/5 hover:border-black focus:outline-none focus:ring-2 focus:ring-black/40 focus:ring-offset-2 focus:ring-offset-transparent hero-fade-in-delayed-4 [text-shadow:_0_1px_2px_rgba(255,255,255,0.35)]";
