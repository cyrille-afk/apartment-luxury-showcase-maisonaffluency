  ...
  return <section ref={ref} className="relative h-screen w-full overflow-hidden">
      <motion.div className="absolute inset-0" style={isMobile ? {} : { y }}>
        <motion.img 
          ...
          className="h-full w-full object-cover object-[50%_40%] md:h-[120%] md:object-[50%_0%] will-change-transform scale-[0.9] md:scale-100 origin-center"
      ...
      <div className="relative z-10 h-full px-4 pb-32 pt-[55%] md:px-12 md:pb-20 md:pt-[22%] lg:px-20 flex-col border rounded-none opacity-100 shadow-none flex items-start justify-start md:justify-start md:items-start">
        <motion.div initial={{
        opacity: 0,
        y: 30
      }} animate={{
