...
const Hero = () => {
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full px-4 pb-32 pt-[34%] md:px-12 md:pb-20 md:pt-[18%] lg:px-20 flex-col border rounded-none opacity-100 shadow-none flex items-start justify-start md:justify-start md:items-start">
        <div className="max-w-4xl md:text-left hero-fade-in">
          ...
          <div className="inline-flex flex-col items-center md:items-end">
            <p className="text-lg leading-relaxed text-white text-left font-serif md:text-xl lg:text-2xl font-medium hero-fade-in-delayed-3">
              ...
              <br /><em>in situ</em>, To the World's most distinguished
      ...
      <div
        ...
        style={{ bottom: "max(8.5rem, calc(env(safe-area-inset-bottom) + 8rem))", animationDelay: "1.2s" }}
      >
        <button
