...
const partnerBrands = [
  ...
  },
  {
    ...
    seatType: "Sofas & Loveseats",
    origin: "Singapore",
    description: "Singapore-based furniture house creating timeless pieces with a focus on quality materials, exceptional comfort, and refined contemporary design.",
