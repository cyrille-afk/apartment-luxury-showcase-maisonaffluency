...
// All designer background images loaded from Cloudinary
const CLD_DESIGNERS = "maison affluency/designers";
const cldDesigner = (name: string) => cloudinaryUrl(`${CLD_DESIGNERS}/${name}`, { width: 1600, quality: "auto:good", crop: "fill" });

const alexanderLamontBg = cldDesigner("alexander-lamont-bg");
const leoAertsBg = cldDesigner("leo-aerts-alinea-bg");
const apparatusBg = cldDesigner("apparatus-studio-bg");
const atelierFevrierBg = cldDesigner("atelier-fevrier-bg");
const atelierDemichelisBg = cldDesigner("atelier-demichelis-bg");
const emmanuelBabledBg = cldDesigner("emmanuel-babled-bg");
const brunoDeMaistreBg = cldDesigner("bruno-de-maistre-bg");
const celsoDeLemosBg = cldDesigner("celso-de-lemos-bg");
const delaEspadaBg = cldDesigner("de-la-espada-bg");
const damienLangloisMeurinneBg = cldDesigner("damien-langlois-meurinne-bg");
const berntPetersenBg = cldDesigner("bernt-petersen-bg");
const erstensBg = cldDesigner("kerstens-bg");
const ccTapisBg = cldDesigner("cc-tapis-bg");
const cristallerieSaintLouisBg = cldDesigner("cristallerie-saint-louis-bg");
const delcourtBg = cldDesigner("delcourt-bg");
const ecartParisBg = cldDesigner("ecart-paris-bg");
const entrelacsBg = cldDesigner("entrelacs-bg");
const garnierLinkerBg = cldDesigner("garnier-linker-bg");
const haymannEditionsBg = cldDesigner("haymann-editions-bg");
const kiraBg = cldDesigner("kira-bg");
const okhaBg = cldDesigner("okha-bg");
const cazesConquetBg = cldDesigner("cazes-conquet-bg");
const hamreiBg = cldDesigner("hamrei-bg");
const ikselBg = cldDesigner("iksel-bg");
const kikoLopezBg = cldDesigner("kiko-lopez-bg");
const leoSentouBg = cldDesigner("leo-sentou-bg");
const manOfPartsBg = cldDesigner("man-of-parts-bg");
const takayokayaBg = cldDesigner("takayokaya-bg");
const theoremeEditionsBg = cldDesigner("theoreme-editions-bg");
const thierryLemaireBg = cldDesigner("thierry-lemaire-bg");
const sergeMouilleBg = cldDesigner("serge-mouille-bg");
const robicaraBg = cldDesigner("robicara-bg");
const peterReedBg = cldDesigner("peter-reed-bg");
const pierreBonnefilleBg = cldDesigner("pierre-bonnefille-bg");
const pinton1867Bg = cldDesigner("pinton-1867-bg");
const ericSchmittBg = cldDesigner("eric-schmitt-bg");
const jindrichHalabalaBg = cldDesigner("jindrich-halabala-bg");
const oliviaCognetBg = cldDesigner("olivia-cognet-bg");
const ooummBg = cldDesigner("ooumm-bg");
const matthieuGicquelBg = cldDesigner("matthieu-gicquel-bg");
const poltronaFrauBg = cldDesigner("poltrona-frau-bg");
const nathalieZieglerBg = cldDesigner("nathalie-ziegler-bg");
const seCollectionsBg = cldDesigner("se-collections-bg");
const maisonWecraftBg = cldDesigner("maison-wecraft-bg");
const herveVanDerStraetenBg = cldDesigner("herve-van-der-straeten-bg");
const pouenatBg = cldDesigner("pouenat-bg");
const valeriaNascimentoBg = cldDesigner("valeria-nascimento-bg");
const simonCabrolBg = cldDesigner("simon-cabrol-bg");
const andreePutmanBg = cldDesigner("andree-putman-bg");
const noomBg = cldDesigner("noom-bg");
const nicolasAubagnacBg = cldDesigner("nicolas-aubagnac-bg");
const ozoneLightBg = cldDesigner("ozone-light-bg");
const collectionParticuliereBg = cldDesigner("collection-particuliere-bg");
const biekeCasteleynBg = cldDesigner("bieke-casteleyn-bg");
const galerieMcdeBg = cldDesigner("galerie-mcde-bg");
const gillesBoissierBg = cldDesigner("gilles-boissier-bg");
const jacobHashimotoBg = cldDesigner("jacob-hashimoto-bg");
const paulCocksedgeBg = cldDesigner("paul-cocksedge-bg");
const leBerreVevaudBg = cldDesigner("le-berre-vevaud-bg");
const binaBaitelBg = cldDesigner("bina-baitel-bg");
const charlesParisBg = cldDesigner("charles-paris-bg");
const victoriaMagniantBg = cldDesigner("victoria-magniant-bg");
const pierreYovanovitchBg = cldDesigner("pierre-yovanovitch-bg");
const brunoMoinardBg = cldDesigner("bruno-moinard-bg");
const noeDuchaufourBg = cldDesigner("noe-duchaufour-lawrance");
const ndlEditionsBg = cldDesigner("ndl-editions-bg");
const pierreAugustinRoseBg = cldDesigner("pierre-augustin-rose-bg");
const redaAmalouBg = cldDesigner("reda-amalou-bg");
const homLeXuanBg = cldDesigner("hom-le-xuan-bg");
const frederiqueRobWhittleBg = cldDesigner("frederique-rob-whittle-bg");
const martinMasseBg = cldDesigner("martin-masse-bg");
const mernoeBg = cldDesigner("mernoe-bg");
const paulinPaulinPaulinBg = cldDesigner("paulin-paulin-paulin-bg");
const stephaneCgBg = cldDesigner("stephane-cg-bg");
const andreaClaireBg = cldDesigner("andrea-claire-studio-bg");
const michelAmarBg = cldDesigner("michel-amar-studio-bg");
const arredoluceBg = cldDesigner("arredoluce-bg");
const articoloStudiosBg = cldDesigner("articolo-studios-bg");
const basedUponBg = cldDesigner("based-upon-bg");
const bryanOSullivanBg = cldDesigner("bryan-osullivan-bg");
const christopherBootsBg = cldDesigner("christopher-boots-bg");
const lostProfileStudioBg = cldDesigner("lost-profile-studio-bg");
const okurayamaStudioBg = cldDesigner("okurayama-studio-bg");
const overgaardDyrmanBg = cldDesigner("overgaard-dyrman-bg");
const stephaneParmentierBg = cldDesigner("stephane-parmentier-bg");
const privatiselectionemBg = cldDesigner("privatiselectionem-bg");
const achilleSalvagniBg = cloudinaryUrl("achille-salvagni-atelier-bg", { width: 1600, quality: "auto:good", crop: "fill" });
const valerieRostaingBg = cldDesigner("valerie-rostaing-bg");
