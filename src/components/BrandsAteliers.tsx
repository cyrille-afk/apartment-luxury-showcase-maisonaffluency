...
const damienLangloisMeurinneBg = cloudinaryUrl("damien-langlois-meurinne-bg_gmicja", { width: 1600, quality: "auto:good", crop: "fill" });
const berntPetersenBg = cloudinaryUrl("bernt-petersen-bg_t4rnoj", { width: 1600, quality: "auto:good", crop: "fill" });
const erstensBg = cloudinaryUrl("kerstens-bg_y065ji", { width: 1600, quality: "auto:good", crop: "fill" });
const ccTapisBg = cloudinaryUrl("cc-tapis-bg_gacubc", { width: 1600, quality: "auto:good", crop: "fill" });
const cristallerieSaintLouisBg = cloudinaryUrl("cristallerie-saint-louis-bg_gkrrzp", { width: 1600, quality: "auto:good", crop: "fill" });
const delcourtBg = cloudinaryUrl("delcourt-bg_whop7p", { width: 1600, quality: "auto:good", crop: "fill" });
const ecartParisBg = cloudinaryUrl("ecart-paris-bg_av3tqr", { width: 1600, quality: "auto:good", crop: "fill" });
const entrelacsBg = cloudinaryUrl("entrelacs-bg_ec6ks7", { width: 1600, quality: "auto:good", crop: "fill" });
...
const kiraBg = cloudinaryUrl("kira-bg_xjzhue", { width: 1600, quality: "auto:good", crop: "fill" });
const okhaBg = cloudinaryUrl("okha-bg_zdmkil", { width: 1600, quality: "auto:good", crop: "fill" });
...
const theoremeEditionsBg = cloudinaryUrl("theoreme-editions-bg_blriy3", { width: 1600, quality: "auto:good", crop: "fill" });
const thierryLemaireBg = cloudinaryUrl("thierry-lemaire-bg_xsf0yz", { width: 1600, quality: "auto:good", crop: "fill" });
const sergeMouilleBg = cloudinaryUrl("serge-mouille-bg_cdd04d", { width: 1600, quality: "auto:good", crop: "fill" });
const robicaraBg = cloudinaryUrl("robicara-bg_nzeadp", { width: 1600, quality: "auto:good", crop: "fill" });
const peterReedBg = cloudinaryUrl("peter-reed-bg_pj2qzu", { width: 1600, quality: "auto:good", crop: "fill" });
const pierreBonnefilleBg = cloudinaryUrl("pierre-bonnefille-bg_ltfqd6", { width: 1600, quality: "auto:good", crop: "fill" });
const pinton1867Bg = cloudinaryUrl("pinton-1867-bg_pa0cjy", { width: 1600, quality: "auto:good", crop: "fill" });
const ericSchmittBg = cloudinaryUrl("eric-schmitt-bg_zle4xe", { width: 1600, quality: "auto:good", crop: "fill" });
const jindrichHalabalaBg = cloudinaryUrl("jindrich-halabala-bg_pn3yfz", { width: 1600, quality: "auto:good", crop: "fill" });
const oliviaCognetBg = cloudinaryUrl("olivia-cognet-bg_dpv8v2", { width: 1600, quality: "auto:good", crop: "fill" });
const ooummBg = cloudinaryUrl("ooumm-bg_nopn7v", { width: 1600, quality: "auto:good", crop: "fill" });
const matthieuGicquelBg = cloudinaryUrl("matthieu-gicquel-bg_l1lciq", { width: 1600, quality: "auto:good", crop: "fill" });
const poltronaFrauBg = cloudinaryUrl("poltrona-frau-bg_xnbfep", { width: 1600, quality: "auto:good", crop: "fill" });
const nathalieZieglerBg = cloudinaryUrl("nathalie-ziegler-bg_ypvltb", { width: 1600, quality: "auto:good", crop: "fill" });
const seCollectionsBg = cloudinaryUrl("se-collections-bg_t6crfo", { width: 1600, quality: "auto:good", crop: "fill" });
const maisonWecraftBg = cloudinaryUrl("maison-wecraft-bg_nsa7fm", { width: 1600, quality: "auto:good", crop: "fill" });
const herveVanDerStraetenBg = cloudinaryUrl("herve-van-der-straeten-bg_titrht", { width: 1600, quality: "auto:good", crop: "fill" });
const pouenatBg = cloudinaryUrl("pouenat-bg_lw3dlo", { width: 1600, quality: "auto:good", crop: "fill" });
const valeriaNascimentoBg = cloudinaryUrl("valeria-nascimento-bg_zca4dy", { width: 1600, quality: "auto:good", crop: "fill" });
const simonCabrolBg = cloudinaryUrl("simon-cabrol-bg_dxky1d", { width: 1600, quality: "auto:good", crop: "fill" });
const andreePutmanBg = cloudinaryUrl("andree-putman-bg_uwufym", { width: 1600, quality: "auto:good", crop: "fill" });
const noomBg = cloudinaryUrl("noom-bg_xjqbb7", { width: 1600, quality: "auto:good", crop: "fill" });
const nicolasAubagnacBg = cloudinaryUrl("nicolas-aubagnac-bg_nt81k3", { width: 1600, quality: "auto:good", crop: "fill" });
const ozoneLightBg = cloudinaryUrl("ozone-light-bg_v2zneb", { width: 1600, quality: "auto:good", crop: "fill" });
const collectionParticuliereBg = cloudinaryUrl("collection-particuliere-bg_hn4jiq", { width: 1600, quality: "auto:good", crop: "fill" });
const biekeCasteleynBg = cloudinaryUrl("bieke-casteleyn-bg_wuhwso", { width: 1600, quality: "auto:good", crop: "fill" });
const galerieMcdeBg = cloudinaryUrl("galerie-mcde-bg_fxxdp6", { width: 1600, quality: "auto:good", crop: "fill" });
...
const paulCocksedgeBg = cloudinaryUrl("paul-cocksedge-bg_bfw68x", { width: 1600, quality: "auto:good", crop: "fill" });
...
const frederiqueRobWhittleBg = cloudinaryUrl("frederique-rob-whittle-bg_arue3i", { width: 1600, quality: "auto:good", crop: "fill" });
const martinMasseBg = cloudinaryUrl("martin-masse-bg_js1sx7", { width: 1600, quality: "auto:good", crop: "fill" });
const mernoeBg = cloudinaryUrl("mernoe-bg_c9nn4i", { width: 1600, quality: "auto:good", crop: "fill" });
const paulinPaulinPaulinBg = cloudinaryUrl("paulin-paulin-paulin-bg_xjxo4m", { width: 1600, quality: "auto:good", crop: "fill" });
const stephaneCgBg = cloudinaryUrl("stephane-cg-bg_fgisjs", { width: 1600, quality: "auto:good", crop: "fill" });
const andreaClaireBg = cloudinaryUrl("andrea-claire-studio-bg_p9ukpu", { width: 1600, quality: "auto:good", crop: "fill" });
const michelAmarBg = cloudinaryUrl("michel-amar-studio-bg_e4da8t", { width: 1600, quality: "auto:good", crop: "fill" });
const arredoluceBg = cloudinaryUrl("arredoluce-bg_uqv7ky", { width: 1600, quality: "auto:good", crop: "fill" });
const articoloStudiosBg = cloudinaryUrl("articolo-studios-bg_b1pj4o", { width: 1600, quality: "auto:good", crop: "fill" });
const basedUponBg = cloudinaryUrl("based-upon-bg_lftlhi", { width: 1600, quality: "auto:good", crop: "fill" });
const bryanOSullivanBg = cloudinaryUrl("bryan-osullivan-bg_jpk9d9", { width: 1600, quality: "auto:good", crop: "fill" });
...
const mmairoBg = cloudinaryUrl("Screen_Shot_2026-02-25_at_3.10.53_AM_cuc62s", { width: 1600, quality: "auto:good", crop: "fill" });
                    ...
                    <div className="relative">
                      ...
                      <div className="relative inline-block">
                        ...
                        <button
                          ...
                          className="absolute bottom-2 left-1 z-50 p-1.5 bg-background/20 hover:bg-background/40 rounded-full backdrop-blur-sm transition-colors"
