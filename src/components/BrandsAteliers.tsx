              ...
              {bg && (
                <img
                  ...
                  style={{
                    ...
                    objectPosition: brand.name === "Baleri Italia" ? "center 20%" : brand.name === "Jindrich Halabala" ? "center center" : brand.name === "Eric Schmitt Studio" ? "center 30%" : brand.name === "Dagmar London" ? "center 45%" : brand.name === "Robicara" ? "center 30%" : brand.name === "Okha" ? "center 30%" : "center top",
                    padding: brand.name === "Baleri Italia" ? "10%" : "0",
                  }}
                />
              )}
              <div className={`absolute inset-0 transition-all duration-300 ${hasBg ? "bg-card/80 group-hover:bg-card/55" : "bg-card/50 group-hover:bg-card/80"}`} />
                    ...
                    <span key={itemIndex} className="flex items-center">
                      {item.featured && item.galleryIndex !== undefined ? (
                        <button
                          ...
                          className="text-xs md:text-sm text-foreground font-body hover:text-primary transition-colors duration-300 flex items-center gap-1 group/link touch-manipulation"
                        >
