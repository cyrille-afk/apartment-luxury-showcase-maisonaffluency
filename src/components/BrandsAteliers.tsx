              ...
              {bg && (
                <img
                  ...
                  style={{
                    ...
                    objectPosition: brand.name === "Baleri Italia" ? "center 20%" : brand.name === "Jindrich Halabala" ? "center center" : brand.name === "Eric Schmitt Studio" ? "center 15%" : brand.name === "Dagmar London" ? "center 30%" : "center top",
