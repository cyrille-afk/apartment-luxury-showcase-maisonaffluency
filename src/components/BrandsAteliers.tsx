  ...
  "ozone-light": {
    ...
    curatorPicks: [
      ...
      },
      {
        ...
        tags: ["Lighting", "Chandelier"],
        materials: "White lacquered aluminium structure and stem with white paper diffusing material\n700 × 700 × H 800 mm – 22 kg\nSilhouette: 1750 mm\nWarm white 2700K LED lighting, 144W, 6600 Lumens\n\nAvailable in multiple LED options: Warm white LED lighting 2200K, or alternatively 2700K\nOptional Dim to Warm, warm white LED lighting from 1900K (low intensity) to 2500K (high intensity), Integrated 24V converters and drivers, CE Class I",
      ...
      },
      {
        ...
        subtitle: "Michel Boyer",
        tags: ["Lighting", "Table Lamp"],
        materials: "Brass, aluminium and steel structure with gloss black or polished stainless steel base, white lacquered shade and white paper diffuser\n280 × 280 × H 710 mm\n\nWarm white LED 2200K or 2700K · Optional Dim to Warm 1900K–2500K · Integrated 24V converters & drivers, CE Class I",
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-1 mb-3 pl-8 md:pl-0">
                  <span className={`text-[10px] md:text-xs uppercase tracking-wider block transition-colors duration-300 ${hasBg ? "text-white/70" : "text-[hsl(var(--gold))]"}`}><em>In Situ</em></span>
