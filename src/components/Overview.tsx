          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6">
            ...
            delay: 0.4
              ...
              className="text-left cursor-pointer group transition-all duration-300 hover:scale-105">
                ...
                <div className="font-body text-xs uppercase tracking-wider text-primary/80 group-hover:text-accent transition-all duration-300 leading-tight flex items-start gap-0.5"><span className="hidden md:inline">Designers works and<br />collectible design pieces<br /><em>in situ</em></span><span className="md:hidden">Designers works and<br />collectible design pieces<br /><em>in situ</em></span> <ChevronRight className="w-4 h-4 text-foreground mt-0.5 shrink-0" /></div>
              </button>
            </motion.div>
