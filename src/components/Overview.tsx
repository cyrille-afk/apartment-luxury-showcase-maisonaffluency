        ...
        duration: 0.8
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6">
            <div className="flex-1 order-1 md:order-1">
              ...
              duration: 0.8,
              delay: 0.3
            }} className="font-display text-sm md:text-base lg:text-lg leading-tight text-foreground text-justify">A 2,400 sq ft showroom located at 1 Grange Garden, Singapore 249631, where professionals and design connoisseurs can find the perfect pieces they are looking for to elevate their interiors.
              </motion.h2>
            </div>
