        ...
        >
          <div>
            ...
            <motion.h2
              ...
              className="mb-8 font-display text-4xl leading-tight text-foreground md:text-5xl lg:text-6xl"
            >
              Where Art Becomes
              <br />
              Living Space
          ...
          <div className="space-y-6">
            ...
            >
              This 4-bedroom residence represents a harmonious dialogue between Eastern
              aesthetics and Western modernism. Each space has been thoughtfully crafted
              to showcase the interplay of texture, light, and artisanal craftsmanship.
            </motion.p>
            ...
            >
              <div>
                <div className="mb-2 font-display text-3xl text-primary">4</div>
                <div className="font-body text-sm uppercase tracking-wider text-muted-foreground">
                  Bedrooms
                </div>
              </div>
              <div>
                <div className="mb-2 font-display text-3xl text-primary">3.5</div>
                <div className="font-body text-sm uppercase tracking-wider text-muted-foreground">
                  Bathrooms
                </div>
              </div>
              <div>
                <div className="mb-2 font-display text-3xl text-primary">2,850</div>
                <div className="font-body text-sm uppercase tracking-wider text-muted-foreground">
                  Sq Ft
                </div>
              </div>
