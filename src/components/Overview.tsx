        ...
        duration: 0.8
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6">
            <div className="flex-1 order-1 md:order-1">
              ...
              duration: 0.8,
              delay: 0.3
            }} className="font-serif text-base md:text-base lg:text-lg leading-relaxed text-foreground text-justify">Located at 1 Grange Garden, Singapore 249631, where professionals and design connoisseurs<br className="hidden md:inline" /> can find the perfect pieces they are looking for to elevate their interiors.
              </motion.h2>
            </div>
            ...
            delay: 0.4
              ...
              className="text-left cursor-pointer group transition-all duration-300 hover:scale-105">
                ...
                <div className="font-body text-xs uppercase tracking-wider text-primary/80 group-hover:text-accent transition-all duration-300 flex items-center gap-0.5">Atmospheres <ChevronRight className="w-3 h-3 md:hidden opacity-60" /></div>
              </button>
               <button
              ...
              className="text-left cursor-pointer group transition-all duration-300 hover:scale-105">
                ...
                <div className="font-body text-xs uppercase tracking-wider text-primary/80 group-hover:text-accent transition-all duration-300 leading-tight"><span className="hidden md:inline">Designers works and<br />collectible design pieces<br /><em>in situ</em></span><span className="md:hidden flex items-start gap-0.5">Designers works and<br />collectible design<br />pieces <em>in situ</em> <ChevronRight className="w-3 h-3 opacity-60 mt-0.5 shrink-0" /></span></div>
              </button>
            </motion.div>
            ...
            <div className="order-4 md:hidden py-4 flex justify-center">
              ...
              delay: 0.6
                ...
                <button
                  ...
                  className="group relative flex flex-row-reverse items-center cursor-pointer transition-all duration-300"
                ...
                >
                  <div className="flex -space-x-2 relative z-10 -ml-3">
                    ...
                    />
                    <img
                      src={cloudinaryUrl("Screen_Shot_2026-02-26_at_9.59.00_PM_wivwhs", { width: 128, quality: "auto", crop: "fill" })}
