...
const Overview = () => {
  ...
  return <section id="overview" ref={ref} className="py-10 md:py-20 px-4 md:px-12 lg:px-20 bg-muted/30 scroll-mt-24">
        ...
        duration: 0.8
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
            <div className="flex-1">
              ...
              duration: 0.6,
              delay: 0.2
            }} className="mb-2 uppercase tracking-[0.3em] text-primary text-sm md:text-lg font-serif">OVERVIEW</motion.p>
              ...
              delay: 0.3
                ...
                <button
                  ...
                  className="inline text-primary hover:text-primary/70 underline decoration-primary/30 hover:decoration-primary/50 transition-all duration-300 cursor-pointer"
                >
