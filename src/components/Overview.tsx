              ...
              delay: 0.6
                ...
                >
                  <div className="flex -space-x-2 relative z-10 -ml-3">
                    <img
                      src={cloudinaryUrl("IMG_2542_1_kc4fvs", { width: 96, quality: "auto", crop: "fill" })}
                      alt="Cyrille Delval"
                    ...
                    />
                    <img
                      src={cloudinaryUrl("Screen_Shot_2026-02-26_at_9.59.00_PM_wivwhs", { width: 96, quality: "auto", crop: "fill" })}
