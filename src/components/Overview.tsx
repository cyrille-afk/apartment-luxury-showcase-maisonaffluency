        ...
        duration: 0.8
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
            <div className="flex-1">
              ...
              duration: 0.8,
              delay: 0.3
            }} className="font-display text-base md:text-xl lg:text-2xl leading-tight text-foreground">A 2,400 sq ft showroom located in Singapore District 9, where professionals and design connoisseurs can find the perfect pieces they are looking for to elevate their interiors
              </motion.h2>
            </div>
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 md:items-start">
            ...
            duration: 0.6,
            delay: 0.5
          }} className="font-serif text-sm md:text-base leading-relaxed text-muted-foreground flex-1">From Thierry Lemaire and Hervé van der Straeten to Pierre Bonnefille and Jeremy Maxwell Wintrebert — a curated venue where design and art congregate.</motion.p>
