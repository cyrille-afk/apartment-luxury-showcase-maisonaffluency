          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
            ...
            delay: 0.4
              ...
              >
                ...
                <div className="font-body text-xs uppercase tracking-wider text-muted-foreground group-hover:text-foreground transition-all duration-300 max-w-[120px] leading-tight">Designers & Collectible Design Pieces In Situ</div>
              </button>
            </motion.div>
          </div>
