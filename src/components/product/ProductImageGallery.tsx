  ...
  return (
    <div className="flex gap-4">
      ...
      <div className="relative group" ref={inlineSwipeRef}>
        <div className={cn("md:aspect-square md:h-auto bg-muted/10 rounded-2xl overflow-hidden relative touch-pan-y transition-[height] duration-300 ease-out md:border-b-0 md:shadow-none border-b border-border/60 shadow-[0_6px_10px_-8px_rgba(0,0,0,0.35)]", compact ? "h-[22vh]" : "h-[42vh]")}>
