...
export default function ExpandableSpec({
  ...
  // NOTE: the former circular CSS-gradient swatch row was removed — those
  // approximated tones rendered before the designer's real swatch library
  // resolved, which read as a broken/flashing loading state. Axes without
  // swatch photography now fall through to the inline text picker below.
