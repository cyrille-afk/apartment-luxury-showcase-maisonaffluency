...
const designersBrands = [
  ...
  },
  {
    ...
    content:
      "Custom lighting fixtures from New York's Apparatus Studio blend traditional craftsmanship with contemporary sensibility. The brass and glass compositions create ambient pools of light that enhance the space's intimate atmosphere.",
  },
];
...
const philosophyPoints = [
  {
    ...
    content:
      "This residence embodies a sophisticated dialogue between Eastern and Western design philosophies. Asian artistic traditions—evident in the hand-painted murals and organic forms—are balanced with Western modernist principles of clean lines and functional elegance. The result is a space that honors both heritages without pastiche.",
  },
  {
    title: "Art as Architecture",
    subtitle: "Integrated Aesthetics",
    content:
      "Rather than treating art as an afterthought, the design integrates artistic expression into the architectural fabric. The mural work isn't merely decorative; it defines spatial boundaries and influences the emotional tone of each room. Furniture pieces are selected for their sculptural merit, blurring the line between functional objects and art.",
  },
  {
      ...
      <div className="mx-auto max-w-5xl">
        ...
        >
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {designersBrands.map((item, index) => (
              <AccordionItem
                key={index}
                value={`designer-${index}`}
                className="border border-border bg-card px-8 py-2 transition-colors hover:bg-muted/30"
              >
