          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8, delay: 0.2 }}>
            ...
            <div className="mb-10 overflow-hidden rounded-sm relative">
              <img
                ...
                className="w-full max-h-[calc(100vh-10rem)] object-cover object-center"
                loading="lazy"
                decoding="async"
              />
              {/* Title & subtitle at top */}
              <div className="absolute top-8 sm:top-12 left-0 right-0 flex flex-col items-center text-center px-4">
