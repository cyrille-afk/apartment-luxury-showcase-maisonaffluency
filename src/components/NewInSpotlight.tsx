      ...
      {isUnderlaid && (
        <section className="hidden md:block w-full bg-transparent">
          <div className="grid grid-cols-12 gap-x-8 items-start w-full mb-8">
            ...
            <div className="col-span-8 flex flex-col justify-start space-y-6 pt-1 h-auto">
              ...
              <div className="w-full border-t border-neutral-100 pt-4 mt-5 flex flex-row items-center justify-between gap-6">
