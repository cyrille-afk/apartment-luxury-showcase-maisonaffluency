...
import DesignerFacetsSidebar from "@/components/DesignerFacetsSidebar";
...
/** Desktop grid is `md:grid-cols-4`, so 4 cards can sit in the first row. */
      ...
      <div className="relative overflow-hidden aspect-square group bg-muted/20">
        ...
        {hasHoverPick && (
          <img
            ...
            decoding="async"
            fetchPriority="low"
            className={`pointer-events-none absolute inset-0 w-full h-full object-cover object-center transition-opacity duration-700 ease-out md:opacity-0 md:group-hover:opacity-100 ${mobileRevealed ? 'opacity-100' : 'opacity-0'}`}
          />
        )}
        {!isLetterA && (
          <>
