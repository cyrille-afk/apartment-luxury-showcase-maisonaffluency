  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className={cn(
          "relative flex flex-col h-full px-6 sm:px-12 md:px-20 lg:px-28 pt-6 md:pt-8 md:-translate-y-6 pointer-events-auto",
            isStandalone
        ...
        {directoryLabels(cn(
          ...
          isStandalone
            ...
            : "bottom-[calc(1.25rem+env(safe-area-inset-bottom))] md:bottom-48"
        ))}
