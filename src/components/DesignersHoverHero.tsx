    ...
    >
      ...
      >
        ...
        <div
          ...
          className={cn(
          // Desktop: generous 80px screen-edge padding for an open, editorial
          // framing. The designers column and right hover label both flush to
          // this wide margin line.
          "relative flex flex-col h-full px-6 sm:px-12 md:px-20 lg:px-20 pointer-events-auto md:overflow-hidden md:h-full",

            isStandalone
              ? "overflow-y-auto justify-start overscroll-contain touch-pan-y pt-10 pb-[calc(10rem+env(safe-area-inset-bottom))] md:pt-8 md:pb-8 md:justify-start md:overflow-hidden [-webkit-overflow-scrolling:touch]"
              : // Mobile browser: the section already starts below the fixed
                ...
                "overflow-y-hidden justify-start overscroll-contain touch-none pt-14 short:pt-12 pb-[calc(4.5rem+env(safe-area-inset-bottom))] md:pt-8 md:justify-start md:pb-8 md:overflow-hidden"
          )}
        >
