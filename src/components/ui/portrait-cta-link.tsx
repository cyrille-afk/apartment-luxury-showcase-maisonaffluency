    ...
    >
      <span
        className={cn(
          ...
          "group-hover/portrait-cta:scale-x-100 group-focus-visible/portrait-cta:scale-x-100 group-active/portrait-cta:scale-x-100",
          pressed && "scale-x-100"
        )}
      />
      <svg
        ...
        className={cn(
          ...
          reversed
            ? ["right-0 -translate-x-[10px] rotate-180 group-hover/portrait-cta:-translate-x-14 group-focus-visible/portrait-cta:-translate-x-14 group-active/portrait-cta:-translate-x-14", pressed && "-translate-x-14"]
            : ["left-0 translate-x-[10px] group-hover/portrait-cta:translate-x-14 group-focus-visible/portrait-cta:translate-x-14 group-active/portrait-cta:translate-x-14", pressed && "translate-x-14"]
        )}
      >
