                            ...
                            {designer.notableWorksLinks ? (
                              ...
                              return (
                                <div className="relative group/avatar pb-4 md:pb-0">
                                  ...
                                  <span className="absolute right-0 md:right-auto md:left-0 top-full mt-1 flex items-center gap-1 text-[8px] md:text-xs font-body text-muted-foreground whitespace-nowrap opacity-100 md:opacity-0 md:group-hover/avatar:opacity-100 pointer-events-none transition-opacity duration-200 z-50">
