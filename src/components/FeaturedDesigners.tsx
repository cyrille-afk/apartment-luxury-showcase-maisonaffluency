...
export const featuredDesigners: (Record<string, any> & { curatorPicks: CuratorPick[]; links?: DesignerLink[] })[] = [
  ...
  },
  {
    ...
    curatorPicks: [
      ...
      { image: garnierLinkerCallistoPendant, title: "Callisto Pendant x 4", category: "Lighting", tags: ["Lighting", "Pendants"], materials: "Pendant in alabaster, patinated brass structure. Each piece is numbered and signed", dimensions: "Without suspension stem (to order): Ø 16 x H 52 cm", pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/assets/pdfs/Garnier_Linker-Callisto_Spec_Sheet.pdf", pdfFilename: "Garnier_Linker-Callisto_Spec_Sheet.pdf" },
      { image: garnierLinkerOrionPendant, title: "Orion Pendant", category: "Lighting", tags: ["Lighting", "Pendants"], materials: "Pendant in alabaster and patinated brass. Each piece is numbered and signed", dimensions: "Ø 11 x L 200 cm. Also exists in length 150 cm", pdfUrl: "https://dcrauiygaezoduwdjmsm.supabase.co/storage/v1/object/public/assets/pdfs/Garnier_Linker-Orion_Spec_Sheet.pdf", pdfFilename: "Garnier_Linker-Orion_Spec_Sheet.pdf" },
