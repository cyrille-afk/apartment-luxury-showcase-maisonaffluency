                ...
                <AccordionTrigger className="hover:no-underline py-4 md:py-6 group active:scale-[0.99] touch-manipulation [&>svg]:hidden md:[&>svg]:block">
                  <div className="flex flex-col w-full gap-3">
                    ...
                    {(designer.notableWorksLink || designer.notableWorksLinks) && (
                      <>
                      <div className="w-16 md:w-24 h-px bg-[hsl(var(--gold)/0.4)] mt-0.5 ml-4 md:ml-[11.5rem]" />
                              ...
                              designer.notableWorksLinks.map((link, linkIdx) => {
                                ...
                                return (
                                  <div key={linkIdx} className="relative group/avatar">
                                    ...
                                    <span className="absolute left-0 top-full mt-1.5 flex items-center gap-1 text-[10px] md:text-xs font-body text-muted-foreground whitespace-nowrap opacity-0 group-hover/avatar:opacity-100 pointer-events-none transition-opacity duration-200 z-50">
                    ...
                    >
                      ...
                      {!isZoomed && (selectedCategory || selectedSubcategory) && (
                        <button
                          ...
                          className="absolute top-2 left-2 z-20 flex items-center gap-1.5 px-2.5 py-1 text-[10px] uppercase tracking-wider font-body bg-black/50 text-white/90 rounded-full border border-white/20 backdrop-blur-sm hover:bg-black/70 transition-all duration-200 cursor-pointer"
