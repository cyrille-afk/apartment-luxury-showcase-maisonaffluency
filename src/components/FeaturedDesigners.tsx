...
import { Instagram, Search, X, ChevronDown, ChevronLeft, ChevronRight, Gem, Maximize2, Minimize2, SlidersHorizontal, FileDown, MessageSquareQuote, CornerDownRight, Scale, LayoutGrid, Grid3X3, Plus } from "lucide-react";
...
export type CuratorPick = { id?: string; image?: string; hoverImage?: string; title: string; subtitle?: string; category?: string; subcategory?: string; tags?: string[]; materials?: string; materials_description?: string | null; dimensions?: string; lead_time?: string | null; origin?: string | null; description?: string; photoCredit?: string; edition?: string; pdfUrl?: string; pdfFilename?: string; pdfUrls?: { label: string; url: string; filename?: string }[]; size_variants?: { label?: string; base?: string; top?: string; price_cents?: number }[] | null; variant_placeholder?: string | null; base_axis_label?: string | null; top_axis_label?: string | null; gallery_images?: string[] | null; variant_image_map?: Record<string, number> | null };
...
export const featuredDesigners: (Record<string, any> & { curatorPicks: CuratorPick[]; links?: DesignerLink[] })[] = [
  ...
  },
  {
    ...
    // Curator picks moved to database (designer_curator_picks). Static list removed to prevent
    // duplicates in the Trade Gallery merge — names diverged (e.g. "Erato Pendant Large" vs "Erato Pendant").
    curatorPicks: [],
    links: [
