                  ...
                  <div className="space-y-4 text-muted-foreground font-body">
                    ...
                    <div className="pt-2 border-t border-border/30 mt-4">
                      ...
                      {designer.links && designer.links.filter(l => l.type !== "Instagram").length > 0 && (
                        <div className="flex flex-wrap gap-3 mt-4 md:pr-8 items-center">
                          ...
                          {/* Mobile WhatsApp share button — next to Curators' Picks */}
                          <Tooltip>
                            <TooltipTrigger asChild>
                              <button
                                onClick={() => {
                                ...
                                className="md:hidden inline-flex items-center justify-center p-2 rounded-full bg-foreground/10 hover:bg-foreground/20 transition-all duration-300 hover:scale-110 cursor-pointer"
                                aria-label={`Share ${designer.name} on WhatsApp`}
                              >
