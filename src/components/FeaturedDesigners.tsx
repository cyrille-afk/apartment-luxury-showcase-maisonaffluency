...
export const featuredDesigners: (Record<string, any> & { curatorPicks: CuratorPick[]; links?: DesignerLink[] })[] = [
  ...
  },
  {
    ...
    notableWorksLink: { text: "Corteza Console Table | Artisan Materials", galleryIndex: 23 },
  ...
  },
  {
    ...
    notableWorksLink: { text: "Amber Folio Lamp for Cristallerie Saint-Louis", galleryIndex: 23 },
