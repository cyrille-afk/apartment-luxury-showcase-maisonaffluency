...
export const featuredDesigners: (Record<string, any> & { curatorPicks: CuratorPick[]; links?: DesignerLink[] })[] = [
  ...
  },
  {
    ...
    notableWorksLinks: [
      { text: "Corteza Console Table | The Details Make The Design", galleryIndex: 23 },
  ...
  },
  {
    ...
    notableWorksLink: { text: "Amber Folio Lamp for Cristallerie Saint-Louis", galleryIndex: 24 },
