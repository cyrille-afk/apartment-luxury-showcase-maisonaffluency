    ...
    curatorPicks: [
      {
        ...
        description: "Embodying the philosophy that a room is best furnished by emptying it, this iconic Jean-Michel Frank sofa marries austere lines with sumptuous leather upholstery over a varnished solid oak frame. Originally designed in 1932 and faithfully re-edited by Ecart Paris, it epitomises Frank's pursuit of luxurious simplicity. Also available as a 2-seater (L 160 × P 89 × H 81 cm).",
      ...
      },
      {
        ...
        description: "One of Jean-Michel Frank's earliest and most recognisable designs, the Croisillon Lamp features a distinctive cross-shaped base in varnished solid oak topped with a patinated brass stem and classic cotton shade. Re-edited by Ecart Paris with the same artisanal precision as the 1924 original. Also available with a solid Walnut, Golden Brass or Black Patinated Brass base.",
      ...
      },
      {
        ...
        description: "A masterpiece of Art Deco craftsmanship, the Soleil Coffee Table showcases Jean-Michel Frank's signature straw marquetry in a radiant sunburst pattern. Each table is hand-assembled by master artisans using individually dyed and cut straw, a painstaking technique that Frank helped elevate to fine art. Re-edited by Ecart Paris, this 1930 design remains one of the most celebrated pieces in 20th-century decorative arts.",
      ...
      },
      {
        ...
        materials: "Straw Marquetry",
        dimensions: "Ø 85 × H 35 cm",
        description: "Detail view of the hand-applied straw marquetry sunburst. Each strand of rye straw is individually selected, dyed and precisely laid to create the luminous radiating pattern that defines this iconic Jean-Michel Frank design. The technique requires weeks of meticulous handwork by specialised artisans trained in this rare craft.",
      ...
      },
      {
        ...
        description: "Named for its broad, enveloping silhouette, the Elephant Armchair is one of Jean-Michel Frank's final and most sculptural designs. The generously proportioned smooth solid oak frame cradles a deep fabric-upholstered seat, offering both visual gravitas and exceptional comfort. Re-edited by Ecart Paris, it is available in various Oak and Walnut finishes on request.",
      ...
      },
      {
        ...
        description: "This commanding round dining table exemplifies Jean-Michel Frank's mastery of surface texture. The top features sandblasted oak marquetry that reveals the wood's natural grain in striking relief, supported by deep sandblasted oak legs. Designed in 1935 and re-edited by Ecart Paris, it seats up to six and brings sculptural presence to any dining space.",
      ...
      },
      {
        ...
        materials: "Sandblasted Oak Marquetry • Deep Sandblasted Oak",
        dimensions: "Ø 150 × H 75 cm",
        description: "Detail view of the sandblasted oak marquetry surface. The sandblasting process strips away softer wood fibres to expose the harder grain, creating a deeply tactile, sculptural texture that catches light and shadow. This finish was a hallmark of Jean-Michel Frank's work, transforming humble oak into a material of extraordinary visual richness.",
      ...
      },
      {
        ...
        description: "A versatile icon of understated elegance, the X Stool features interlocking sandblasted varnished oak legs in a distinctive cross formation, crowned with a taut foal hide seat. Designed by Jean-Michel Frank in 1934 in collaboration with Adolphe Chanaux and re-edited by Ecart Paris, it serves equally as an occasional seat, side table, or sculptural accent.",
