...
const featuredDesigners = [
  ...
  },
  {
    ...
    biography:
      "Léo Aerts is a Belgian designer whose studio Alinea Design Objects has become renowned for its mastery of stone and its sculptural approach to furniture. Working primarily with marble, onyx, and volcanic stone, Aerts creates pieces that feel simultaneously ancient and contemporary. His Angelo collection — tables of monumental scale — has been acquired by collectors and featured in major interiors publications worldwide.",
    notableWorks: "Angelo W Dining Table, Angelo M Side Table, Twin Chair, Visible M Display Cabinet",
    notableWorksLink: { text: "Custom Angelo M Table", galleryIndex: 2 },
    philosophy: "Stone is not a material — it is time made visible. I try to find in each slab the form that was always waiting inside it.",
    curatorPicks: [
      {
        image: leoAertsAngeloMCollection,
        title: "Angelo W",
        subtitle: "Dining Table — Limited Edition of 7",
        category: "Tables",
        tags: ["Tables", "Dining Table"],
        materials: "Marble top • Solid stone base",
      ...
      },
      {
        ...
        category: "Tables",
        tags: ["Tables", "Side Table"],
        materials: "Marble • Macassar ebony",
        dimensions: "Ø 55 × H 50 cm",
      },
      {
        ...
        category: "Storage",
        tags: ["Storage", "Display Cabinet"],
        materials: "Glass • Steel frame • Stone base",
        dimensions: "120 × 45 × 45 cm / Overall: 120 × 45 × 125 cm",
      },
      {
      ...
      },
      {
        ...
        title: "Angelo M",
        subtitle: "Dining Configuration",
        category: "Tables",
        tags: ["Tables", "Dining Table"],
        materials: "Marble • Solid stone",
      ...
      },
      {
        ...
        category: "Seating",
        tags: ["Seating", "Outdoor Chair"],
        materials: "Powder-coated steel • Weather-resistant upholstery",
        dimensions: "65 × 72 × 78 cm H",
      },
    ],
    links: [
      { type: "Instagram", url: "https://www.instagram.com/leoaerts_alinea/" },
      { type: "Curators' Picks" },
    ],
  },
  {
    id: "adam-courts",
    name: "Adam Courts — Okha",
    founder: "Adam Courts",
    specialty: "Collectible Furniture & Contemporary African Design",
    image: adamCourtsOkhaImg,
    biography:
      "Adam Courts is the creative director of Okha, a South African design studio that has earned international recognition for its bold, sculptural furniture. Drawing on personal narratives, African cultural heritage, and a deep engagement with materiality, Courts creates pieces that challenge the boundary between art and function. Okha's work is collected globally and has been exhibited at Design Miami, Salon Art + Design New York, and PAD London.",
    notableWorks: "Void Chair, Geometer Desk, Geometer Bench, Angelo Sofa",
    notableWorksLink: { text: "Villa Pedestal Nightstand", galleryIndex: 10 },
    philosophy: "Design is a personal narrative. Every object I make is an attempt to tell a story — about place, about time, about what it means to live beautifully in Africa today.",
    curatorPicks: [
      {
        ...
        category: "Seating",
        tags: ["Seating", "Lounge Chair"],
        materials: "Powder-coated steel • Full leather upholstery",
        dimensions: "H75 × W72 × D75 cm",
      },
      {
      ...
      },
      {
        ...
        category: "Seating",
        tags: ["Seating", "Bench"],
        materials: "Solid hardwood • Natural stone top",
        dimensions: "H45 × W150 × D40 cm",
      },
      {
        image: adamCourtsSofaFront,
        title: "Angelo Sofa",
        subtitle: "Three-Seater",
        category: "Seating",
        tags: ["Seating", "Sofa"],
        materials: "Solid walnut frame • Premium bouclé upholstery",
        dimensions: "H72 × W230 × D90 cm",
      },
      {
        ...
        category: "Storage",
        tags: ["Storage", "Sideboard"],
        materials: "Solid oak • Patinated brass hardware",
        dimensions: "H75 × W180 × D45 cm",
      },
    ],
    links: [
      { type: "Instagram", url: "https://www.instagram.com/okhadesign/" },
      { type: "Curators' Picks" },
    ],
  },
];
