...
const milanPekarImg = dImg("milan-pekar");
const atelierPendhapaImg = dImg("atelier-pendhapa");
const yvesMacheretImg = dImg("yves-macheret");
const nathalieZieglerImg = dImg("nathalie-ziegler");
const leoAertsAlineaImg = dImg("leo-aerts-alinea");
const pierreBonnefulleImg = dImg("pierre-bonnefille");
...
const garnierLinkerImg = dImg("garnier-linker");
const robicaraImg = dImg("robicara-v2");
const redaAmalouImg = dImg("reda-amalou");
const noeDuchaufourImg = dImg("noe-duchaufour-lawrance");
const binaBAitelImg = dImg("bina-baitel");
const tristanAuerImg = dImg("tristan-auer");
const manOfPartsImg = dImg("man-of-parts");
const kerstensImg = dImg("kerstens");
const felixAgostiniImg = dImg("felix-agostini");
const ecartParisImg = dImg("ecart-paris");
const kiraImg = dImg("kira");
