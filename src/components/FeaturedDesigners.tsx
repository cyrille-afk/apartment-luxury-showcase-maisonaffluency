                              ...
                              designer.notableWorksLinks.map((link, linkIdx) => {
                                ...
                                return (
                                  <div key={linkIdx} className="relative group/avatar md:pb-0">
                                    ...
                                    <span
                                      className={`absolute ${designer.notableWorksLinks && designer.notableWorksLinks.length <= 2 ? 'left-0' : 'right-0'} md:right-auto md:left-0 top-full mt-1 flex items-center gap-0.5 text-[9px] md:text-xs font-body text-foreground md:text-muted-foreground whitespace-nowrap opacity-100 md:opacity-0 md:group-hover/avatar:opacity-100 pointer-events-none transition-opacity duration-200 z-50 translate-y-[var(--tooltip-mobile-offset)] md:translate-y-0`}
