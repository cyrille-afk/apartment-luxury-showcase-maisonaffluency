-- =====================================================================
-- 1. SKU uniqueness (partial: allows NULL and empty-string blanks)
-- =====================================================================
CREATE UNIQUE INDEX IF NOT EXISTS trade_products_sku_key
  ON public.trade_products (sku)
  WHERE sku IS NOT NULL AND sku <> '';

-- =====================================================================
-- 2. match_catalog_filtered: prefer canonical lead_time_weeks_max
--    over regex-parsed lead_time text. Falls back to regex when null.
--    Picks table has no numeric lead columns, so its branch stays on text.
-- =====================================================================
