...
const doc = await buildQuotePdf({
  quoteNumber: "QU-VERIFY",
  status: "priced",
  statusLabel: "Priced",
  createdAt: new Date("2026-05-29T00:00:00Z"),
  expiryAt: new Date("2026-06-29T00:00:00Z"),
  clientName: "Verification Client",
  projectName: "Shipping Total Verification",
  currency: "EUR",
  lines: [{
    productName: "Lady Bug Chair",
    brandName: "Maison Test",
    quantity: 1,
    unitPriceCents: 213716,
    lineTotalCents: 213716,
    leadTime: "18-20 weeks",
    shipOriginCountry: "FR",
    shipMode: "air",
    shipCbm: 0.5,
    shipWeightKg: 80,
  }],
  subtotalCents: 213716,
  tradeDiscountPct: 0,
  tradeDiscountApplied: false,
  gstEnabled: false,
  gstRate: 0,
  insurancePremiumCents: 0,
  shippingEstimateCents: 79784,
  shippingShipmentCount: 1,
});
const arr = doc.output("arraybuffer");
await Bun.write("/tmp/quote-verify.pdf", new Uint8Array(arr));
