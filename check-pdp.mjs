...
await page.goto('http://localhost:8080/product/angelo-mh-high-table', { waitUntil: 'domcontentloaded' }).catch(()=>{});
// find a product link
await page.waitForTimeout(4000);
const href = '/product/angelo-mh-high-table'; const _unused = await page.evaluate(() => {
